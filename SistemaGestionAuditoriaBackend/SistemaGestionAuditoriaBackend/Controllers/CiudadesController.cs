...
namespace SistemaGestionAuditoriaBackend.Controllers
{
    ...
    public class CiudadesController : ControllerBase
    {
        ...
        // GET: api/Ciudades/5
        [HttpGet("{id}")]
        public async Task<ActionResult<Ciudad>> GetCiudade(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutCiudade(int id, Ciudad ciudad)
        {
            if (id != ciudad.Id)
            {
                return BadRequest();
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<Ciudad>> PostCiudade(Ciudad ciudad)
        {
